...
tileImages[0].src = "../assets/ZombieIsland/map/two.png";
tileImages[1].src = "../assets/ZombieIsland/map/one.png";
...
directions.forEach(dir => {
    ...
    zombieImages[dir].src = `../assets/ZombieIsland/zombie/${dir}.png`; 
});
...
function displayGame() {
    if (player.health > 0) { //If the player is alive
            ...
            if (zombie[i].health <= 0) { //If zombie is dead
                ...
                if (index > -1) { //When its found
                    if (Math.floor(Math.random() * 11) > 7) { //30% chance to drop ammo
                        drops.push(new Drop(0, 0, 10, "../assets/ZombieIsland/drops/ammo-drop.png", zombie[i].position, zombie[i].toPosition, false)); //Add the drop to the list of drops
                    } else if (Math.floor(Math.random() * 11) > 5) { //50% chance to drop a healing heart
                        drops.push(new Drop(10, 0, 0, "../assets/ZombieIsland/drops/health-drop.png", zombie[i].position, zombie[i].toPosition, false)); //Add the drop to the list of drops
                    }
        ...
        hotbarImage.src = "../assets/ZombieIsland/game/hotbar.png"
